...
class Payment(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        tran = Transaction.objects.all().filter(customer_id=self.request.user, status='CONFIRMED', shop_id=request.POST.get('shop_id'), amount=request.POST.get('bill_amount'))
        tran.status = 'PAID'
        tran.save()
